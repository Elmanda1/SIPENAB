...
<div class="bento-dashboard">
    <div class="bento-card glass-panel col-12 row-4 table-container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div id="ajaxTableContainer">
            <?= view('mahasiswa/table_partial') ?>
        </div>
    </div>
</div>

<script>
    // Inisialisasi elemen dan filter pada halaman daftar mahasiswa
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Proses input pencarian dengan jeda waktu (debounce)
        ...
        // Ambil data mahasiswa secara real-time via AJAX
        async function performSearch() {
            ...
            try {
                ...
                // We need to parse the HTML to get the inner content of the partial
                ...
                if (newContent) {
                    ...
                    // Update total count in header if it exists in the partial
                ...
                // Re-initialize AOS if needed, although it might not be necessary for inner table
