...
<header class="reveal" style="margin-bottom: 4rem;">
    <h1 style="margin: 0;">Matriks<br>Penilaian</h1>
    <div style="margin-top: 1rem; border-top: 8px solid var(--ink); padding-top: 1rem;">
        <div style="font-weight: 800; text-transform: uppercase; font-size: 1.2rem;">
            Manajemen Database // Node Evaluasi
        </div>
    </div>
</header>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            ...
            <?php 
                ...
                $statusText = $count > 0 ? 'TERCATAT: ' . $count . ' METRIK' : 'MENUNGGU_INPUT';
            ?>
            <tr style="border-bottom: 2px solid var(--ink); transition: background 0.2s;" onmouseover="this.style.background='#f9f9f9'" onmouseout="this.style.background='white'">
                ...
                <td style="padding: 2rem 1rem; text-align: right;">
                    <div style="display: flex; justify-content: flex-end; gap: 1rem;">
                        <a href="<?= site_url('penilaian/new?mahasiswa_id='.$m['id']) ?>" style="color: var(--ink); text-decoration: none; border: 2px solid var(--ink); padding: 0.5rem 1rem; font-weight: 800; font-size: 0.7rem;">[ PERBARUI_MATRIKS ]</a>
                    </div>
                </td>
            </tr>
            <?php endforeach; ?>
...
<footer class="reveal" style="margin-top: 2rem; display: flex; justify-content: space-between; align-items: center; color: #666; font-size: 0.8rem;">
    ...
    <div>ALGORITMA: SIAP_UNTUK_EVALUASI</div>
</footer>
<?= $this->endSection() ?>
