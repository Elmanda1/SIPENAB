...
// Support Routes
$routes->get('panduan', 'Support::panduan');
$routes->get('metode', 'Support::metode');
$routes->get('faq', 'Support::faq');
$routes->get('kontak', 'Support::kontak');
$routes->cli('dss/analyze', 'DssAnalysis::index');
